<template>
  <v-app>
    <v-app-bar app elevation="0">
      <v-subheader
        ><h1 class="green--text">
          Portfolio<span class="pink--text">.in</span>
        </h1></v-subheader
      >
      <v-tabs
        center-active
      ...
      <section class="intro-section" id="home">
        <v-row class="align-center px-10" style="height: 690px">
          <v-col lg="6" cols="6" class="pa-6 font-weight-bold py-16">
            <h2 class="display-3">
              Visual <span class="green--text">Design</span> &
              <span class="pink--text">Art</span> Director
            </h2>
            <v-subheader
              >Hi, I am Sanchita, focusing on creating emotional
              experiences.</v-subheader
            >
            <br />
            <br />
            <v-btn
          ...
          <v-col lg="6" cols="6">
            <v-img
              src="https://preview.colorlib.com/theme/jackco/assets/img/hero/xhero_right.png.pagespeed.ic.U76_mb-Zcf.webp"
            ></v-img>
          </v-col>
        </v-row>
      </section>
            ...
            <v-col cols="12" lg="6">
              <v-card class="pa-6 rounded-xl" elevation="5">
                <div class="d-flex align-center justify-space-between">
                  ...
                  <a class="green--text"
                    >at School of California<v-icon color="green"
                      >mdi-link</v-icon
                    ></a
                  >
                </div>
        ...
        >
          <v-container>
            <h4 class="display-1 text-center mb-5">
              I’m a designer, based in India. Currently a freelancer.
              You can see my hobbies on @Sanchita-Co and some photos on me too.
            </h4>
            <v-divider />
            <br />
            <v-row>
          ...
          <v-footer class="mt-4">
            <v-col class="text-center" cols="12">
              <strong
                ...
                This is made by
                <a href="" class="green--text">Sanchita Barik</a>
              </strong>
            </v-col>
          </v-footer>
        </v-img>
